...
namespace Invector.vShooter
{
    ...
    public class vCreateShooterCharacterEditor : EditorWindow
    {
        ...
        void Create()
        {
            ...
            _3rdPerson.name = "vShooterController_" + charObj.gameObject.name;
            _3rdPerson.AddComponent<vThirdPersonController>();
            _3rdPerson.AddComponent<vShooterMeleeInput>();
            _3rdPerson.AddComponent<vShooterManager>();
            _3rdPerson.AddComponent<vAmmoManager>();
            _3rdPerson.AddComponent<vHeadTrack>();
