...
namespace CMF
{
	...
	public class Mover : MonoBehaviour
	{
		...
		//References to attached components TODO;
		public Collider col;
		...
		void Awake()
		{
			...
			//Initialize sensor;
			sensor = new Sensor(sensorTransform, col);
			sensor.SetCastOrigin(sensorTransform.position);
		...
		void RecalibrateSensor()
		{
			...
			sensor.SetCastOrigin(sensorTransform.position);//GetColliderCenter());
