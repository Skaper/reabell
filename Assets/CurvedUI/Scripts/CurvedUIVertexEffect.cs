...
namespace CurvedUI
{
    ...
    public partial class CurvedUIVertexEffect : BaseMeshEffect
    {
        ...
        void CheckTextFontMaterial()
        {
            ...
            if (myText)
            {
                Debug.LogError("NEW VERSION ERROR! \n \t  Operator '!=' is ambiguous on operands of type 'Vector4' and 'Vector2'");
        ...
        UIVertex TesselateQuad(float x, float y)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                Debug.LogError("NEW VERSION ERROR! \n \t  Operator '+=' is ambiguous on operands of type 'Vector2' and 'Vector4'");
